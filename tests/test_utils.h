 ...
 * structures, and types for both runner.c and all test_xxx.c
 *  - function format: a function pointer, return type: int, takes no
 *    parameters
 ...
 *        values for now, but they will be set in corresponding .c files.
 */
/* --------hashing-------- */
